Akan names are traditional names for the Akan people of Ivory Coast and Ghananians
It is primarily determined by day of the week,month and year a child was born
This helps them reflect with their soul and character
The days often follow a specific pattern eg.,"K"/"Kw" for males and 'A' for females
Hence this is why i came up with the Akan name generator to make things easier and faster in order to know about our souls
I figured it is good to incorperate technology and traditions
# Akan Name Generator (No JavaScript) 🔧
...
- If the UI requires input handling that uses JavaScript, simply consult the Day → Name chart below instead.

> Note: This project contains JavaScript files in the repository. This README intentionally avoids any instructions that depend on client-side JS — it focuses on a JS-free workflow.

---

## Akan Day-to-Name Chart

> Tip: Names may have regional spelling variants (for example, Kwasi / Kwesi or Afua / Afia).
...
- Static pages: Add the chart or breakdown directly in HTML so users can visually find their name without dynamic behavior.
